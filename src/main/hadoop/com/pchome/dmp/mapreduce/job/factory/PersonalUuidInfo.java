...
public class PersonalUuidInfo extends APersonalInfo {
	...
	public Object personalData(Map<String, Object> map) throws Exception {
		...
		Map<String, com.pchome.dmp.mapreduce.job.categorylog.CategoryLogMapper.combinedValue> clsfyCraspMap = (Map<String, com.pchome.dmp.mapreduce.job.categorylog.CategoryLogMapper.combinedValue>) map.get("ClsfyCraspMap");
