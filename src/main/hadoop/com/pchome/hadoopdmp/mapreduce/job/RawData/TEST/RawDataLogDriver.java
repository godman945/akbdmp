...
public class RawDataLogDriver {
	...
	public void drive(String env,String timeType) throws Exception {
		...
		Job job = new Job(jobConf, "dmp_RawData_log " + sdf.format(date));
		job.setJarByClass(RawDataLogDriver.class);
		job.setMapperClass(RawDataLogMapper.class);
		job.setMapOutputKeyClass(Text.class);
		job.setMapOutputValueClass(Text.class);
		job.setReducerClass(RawDataLogReducer.class);
		...
		if (timeType.equals("day")) {
			...
			//輸入
			String adLogClassPpath = "/home/webuser/akb/storedata/alllog/2018-05-22/17";			//測試path整天log
			//輸出
...
//		System.out.println(timePath);
		...
		RawDataLogDriver CategoryDriver = (RawDataLogDriver) ctx.getBean(RawDataLogDriver.class);
