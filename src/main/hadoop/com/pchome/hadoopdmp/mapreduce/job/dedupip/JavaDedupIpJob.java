...
public class JavaDedupIpJob {
	...
	public static void main(String[] args) throws Exception {
		...
		/* 輸入資料的HDFS路徑 */
		FileInputFormat.addInputPath(job, new Path("/home/webuser/analyzer/storedata/alllog/2017-05-01"));//home/webuser/dmp/testData/category為測試資料
		/* 輸出資料的HDFS路徑 */
		FileOutputFormat.setOutputPath(job, new Path("/home/webuser/bessie/output/dedupIp0501.txt"));
