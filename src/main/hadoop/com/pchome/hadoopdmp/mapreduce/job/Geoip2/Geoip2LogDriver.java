...
//
//@Component
//public class Geoip2LogDriver {
//
//	private static Log log = LogFactory.getLog("Geoip2LogDriver");
//
...
//		log.info("----job start----");
//
//		Job job = new Job(jobConf, "dmp_Geoip2_log " + sdf.format(date));
//		job.setJarByClass(Geoip2LogDriver.class);
//		job.setMapperClass(Geoip2LogMapper.class);
//		job.setMapOutputKeyClass(Text.class);
//		job.setMapOutputValueClass(Text.class);
//		job.setReducerClass(Geoip2LogReducer.class);
...
//		Geoip2LogDriver CategoryDriver = (Geoip2LogDriver) ctx.getBean(Geoip2LogDriver.class);
