...
public class DmpLogDriver {
	...
	public void drive(String env,String timeType) throws Exception {
		try {
			...
			jobConf.set("mapred.max.split.size","2003886088"); //200388608  10	//200388 645	//2003886	72
			jobConf.set("mapred.min.split.size","2003886088"); //200388608  10  //200388 645	//2003886	72
