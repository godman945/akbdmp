...
public class MyCombiner extends Reducer<Text, Text, Text, Text> {
	...
	private static Log log = LogFactory.getLog("MyCombiner");
...
//	List<JSONObject> kafkaList = new ArrayList<>();
	...
	public void setup(Context context) {
		log.info(">>>>>> MyCombiner  setup>>>>>>>>>>>>>>env>>>>>>>>>>>>"+context.getConfiguration().get("spring.profiles.active"));
		try {
...
//			log.info(">>>>>>MyCombiner write key:" + sendKafkaJson.toString());
